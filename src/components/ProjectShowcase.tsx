...
export function ProjectShowcase() {
    ...
    return <section
        className="pb-27.5 w-[min(100%-48px,1280px)] mx-auto max-[760px]:pb-17.5 max-[760px]:w-[min(100%-32px,1280px)]"
    ...
    >
        ...
        <div className="group" onMouseLeave={() => setActiveId(null)}>
            <div className="relative overflow-hidden mt-14 w-[min(100%,1720px)] border-b border-line [container-type:inline-size] mask-[linear-gradient(90deg,transparent,#000_4%,#000_96%,transparent)]">
                <div
            ...
            >
                ...
                <div className="self-center max-w-107.5">
