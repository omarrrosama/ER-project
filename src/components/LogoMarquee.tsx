...
export function LogoMarquee() {
    ...
    return <section
        className="pt-18 pb-30 w-[min(100%-48px,1280px)] mx-auto max-[760px]:pb-22.5 max-[760px]:w-[min(100%-32px,1280px)]"
    ...
    >
        ...
        <div className="relative overflow-hidden mt-10.5 [mask-image:linear-gradient(90deg,transparent,#000_8%,#000_92%,transparent)]">
            <div className="flex w-max animate-marquee motion-reduce:animate-none motion-reduce:flex-wrap motion-reduce:w-full motion-reduce:[transform:none]">
                {logos.map((company, index) => <div className="grid place-items-center flex-none w-[clamp(160px,18vw,240px)] h-[70px] border-l border-line opacity-[.62]" key={`${company.name}-${index}`}>
